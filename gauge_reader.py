...
def main():
    # Paths to models
    detect_model_path = r"C:\\Users\\bevan\\OneDrive\\Desktop\\DEV_STUFF\\VS FILES\\guage_reader\\gauge-yolov11\\runs\\detect\\gauge-detect6"
    pose_model_path = r"C:\\Users\\bevan\\OneDrive\\Desktop\\DEV_STUFF\\VS FILES\\guage_reader\\gauge-yolov11\\runs\\pose\\gauge-pose-cuda"
    ...
    if choice == '1':
        ...
        if not img_path:
            img_path = r"C:\\Users\\bevan\\OneDrive\\Desktop\\DEV_STUFF\\VS FILES\\guage_reader\\gauge-yolov11\\Screenshot 2025-06-09 120205.png"
